...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630">
  ...
  <text x="100" y="352" font-family="Helvetica, Arial, sans-serif" font-size="30" fill="#5c5a55">Notes on AI engineering, agents and software architecture.</text>
  <text x="100" y="546" font-family="Helvetica, Arial, sans-serif" font-size="26" fill="#2d5f80" letter-spacing="1">ryannel.dev</text>
</svg>`;
